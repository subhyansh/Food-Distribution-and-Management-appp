...
public class viewavailable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AVAILABLE FOOD");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Food", "Quantity", "Restaurnt", "Address", "City", "Contact", "Note"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        shelterhome res = new shelterhome();
        res.show();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String user = "root";
        String pwd = "Root";
        String query= "select * from showavl";
        try
        {
            ...
            while(rs.next())
            {
                ...
                String rest = rs.getString("restaurent");
                String add = rs.getString("address");
                String city = rs.getString("city");
                String contact = rs.getString("contact");
                String note = rs.getString("note");
                model.addRow(new Object[] {food,qty,rest,add,city,contact,note});
            }
            rs.close();
            stm.close();
        }catch(Exception e){
